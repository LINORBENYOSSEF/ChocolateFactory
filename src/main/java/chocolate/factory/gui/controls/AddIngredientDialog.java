...
public class AddIngredientDialog extends Dialog<Ingredient> {
    ...
    public AddIngredientDialog() {
        ...
        setResultConverter((dialogButton) -> {
            ...
            if (data == ButtonBar.ButtonData.OK_DONE) {
                ...
                ingredient.setPriceInDollars(priceField.valueProperty().getValue().doubleValue());
                ingredient.setAmount(amountField.valueProperty().getValue().intValue());
